...
const values = [
  ...
  { icon: Users, title: "For Students <span aria-hidden='true'>👨‍🎓</span>", desc: "Class 9-12 ke students jo stream selection mein confused hain — unke liye humne ye platform banaya hai. Simple, free, aur effective." },
